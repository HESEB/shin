...
(function(){if(window.__shinSharedLoader)return;window.__shinSharedLoader=true;function loadOne(src){var s=document.createElement('script');s.src=src;s.defer=true;document.head.appendChild(s)}function load(){var base=location.pathname.indexOf('/games/')>-1?'../../':'./';loadOne(base+'js/audio.js?v=1');loadOne(base+'js/rc-fixes.js?v=1')}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',load);else load()})();
